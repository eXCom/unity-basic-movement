...
public class HumanoidLandController : MonoBehaviour
{
    ...
    {
        Vector3 calculaterPlayerRunSpeed = _playerMoveInput;
        if (_input.MoveIsPressed && _input.RunIsPressed)
        {
            calculaterPlayerRunSpeed.x *= _runMultiplier;
            calculaterPlayerRunSpeed.z *= _runMultiplier;
        }

        return calculaterPlayerRunSpeed;
    }
